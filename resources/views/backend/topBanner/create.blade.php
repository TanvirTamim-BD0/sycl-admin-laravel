        ...
        <div class="content-header row">
            <div class="content-header-left col-md-9 col-12 mb-2">
                <div class="row breadcrumbs-top">
                    <div class="col-12">
                        <h2 class="content-header-title float-left mb-0">Top Banner Create</h2>
                        <div class="breadcrumb-wrapper">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="{{ route('home') }}">Home</a>
                                </li>
                                <li class="breadcrumb-item active">Top Banner Create
                                </li>
                            </ol>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form id="jquery-val-form" action="{{ route('top-banner.store') }}" method="post"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-6 col-12">
                                                <div class="form-group">
                                                    ...
                                                    <input id="top_banner_title" type="text" class="form-control" name="top_banner_title"
                                                           placeholder="Enter Top Banner Title" value="{{ old('top_banner_title') }}">
                                            ...
                                            <div class="col-lg-12 col-md-12 col-sm-12 col-12 mt-1">
                                                <div class="form-group">
                                                    ...
                                                    <textarea class="form-control" name="top_banner_description" id="top_banner_description" cols="30" value="{{ old('square_banner_description') }}" ></textarea>

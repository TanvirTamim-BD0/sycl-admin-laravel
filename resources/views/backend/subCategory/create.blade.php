    ...
    <div class="content-header row">
        <div class="content-header-left col-md-9 col-12 mb-2">
            <div class="row breadcrumbs-top">
                <div class="col-12">
                    <h2 class="content-header-title float-left mb-0">Sub Category Create</h2>
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form id="jquery-val-form" action="{{ route('sub-category.store') }}" method="post"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-12">
                                        <div class="form-group">
                                            ...
                                            placeholder="Enter Sub Category Name" value="{{ old('sub_category_name') }}">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control select2" name="middle_category_id">
                                                ...
                                                <option value="{{$middleCategory->id}}">{{$middleCategory->middle_category_name}}</option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-12  mt-1">
                                        <div class="media">
                                            <a href="javascript:void(0);" class="mr-25">
                                                <img src="{{ asset('backend/default.png') }}" id="account-upload-img" class="rounded mr-50" alt="profile image" height="80" width="80" style="object-fit: contain;" />
                                            </a>

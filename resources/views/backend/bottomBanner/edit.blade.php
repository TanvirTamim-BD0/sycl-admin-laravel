    ...
    <div class="content-header row">
        <div class="content-header-left col-md-9 col-12 mb-2">
            <div class="row breadcrumbs-top">
                <div class="col-12">
                    <h2 class="content-header-title float-left mb-0">Bottom Banner Edit</h2>
                    <div class="breadcrumb-wrapper">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{ route('home') }}">Home</a>
                        </li>
                        <li class="breadcrumb-item active">Bottom Banner Edit
                        </li>
                    </ol>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form id="jquery-val-form" action="{{ route('bottom-banner.update',$bottomBanner->id) }}" method="post"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-5 col-md-5 col-sm-5 col-12">
                                        <div class="media">
                                            <a href="javascript:void(0);" class="mr-25">
                                                @if(isset($bottomBanner->bottom_banner_image) && $bottomBanner->bottom_banner_image != null)
                                                <img src="{{ asset('/uploads/bottom_banner_image/'.$bottomBanner->bottom_banner_image) }}" id="account-upload-img" class="rounded mr-50" alt="profile image" height="90" width="160" style="object-fit: contain;" />
                                                @else
                                    ...
                                    <div class="col-lg-7 col-md-7 col-sm-7 col-12">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control select2" name="banner_category_id">
                                                ...
                                                <option value="{{$bannerCategory->id}}" {{ $bannerCategory->id == $bottomBanner->banner_category_id ? 'selected' : '' }} >{{$bannerCategory->banner_category_name}}</option>
                                                @endif
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="col-lg-4 col-md-4 col-sm-4 col-12 mt-2">
                                        <div class="form-group">
                                            ...
                                            placeholder="Enter Bottom Banner Text 1" value="{{$bottomBanner->bottom_banner_text_1}}">
                                    ...
                                    <div class="col-lg-4 col-md-4 col-sm-4 col-12 mt-2">
                                        <div class="form-group">
                                            ...
                                            placeholder="Enter Bottom Banner Text 2" value="{{$bottomBanner->bottom_banner_text_2}}">
                                    ...
                                    <div class="col-lg-4 col-md-4 col-sm-4 col-12 mt-2">
                                        <div class="form-group">
                                            ...
                                            placeholder="Enter Bottom Banner Text 3" value="{{$bottomBanner->bottom_banner_text_3}}">
